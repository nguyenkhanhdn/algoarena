...
export const mockLearningPaths: LearningPath[] = [
  {
    id: 'path-1',
    title: 'Lộ trình 1 – Nền tảng Cú pháp, Hàm & Chuỗi',
    slug: 'nen-tang-lap-trinh',
    description: 'Nắm vững cú pháp Python/C++ chuẩn thi đấu, thiết kế Hàm & Thủ tục, Xử lý Chuỗi (String), I/O nhanh và tối ưu Big-O.',
    order: 1,
    badge: 'Nền tảng',
    topicsCount: 3,
  ...
  {
    id: 'path-2',
    title: 'Lộ trình 2 – Thuật toán Cơ bản, Số học, Đệ quy & Vét cạn',
    slug: 'thuat-toan-co-ban',
    description: 'Trụ cột kỳ thi HSG: Số học & Sàng nguyên tố, Đệ quy & Tháp Hà Nội, Vét cạn & Quay lui, Mảng cộng dồn, Hai con trỏ, Chặt nhị phân.',
    order: 2,
    badge: 'Cơ bản',
    topicsCount: 7,
